        ...
        5448: function (t, e, r) {
            ...
            t.exports = function (t) {
                return new Promise((function (e, r) {
                    ...
                    var x = l(A);
                    x && -1 === ["http", "https", "file"].indexOf(x) ? r(new h("Unsupported protocol " + x + ":", h.ERR_BAD_REQUEST, t)) : w.send(y)
                }))
            }
        },
        1609: function (t, e, r) {
                ...
                var e = {
                        991: function (t, e) {
                            ...
                            e.byteLength = function (t) {
                                ...
                                for (var e, n = t.length, o = n % 3, i = [], s = 16383, u = 0, a = n - o; u < a; u += s) i.push(c(t, u, u + s > a ? a : u + s));
                            ...
                            function c(t, e, r) {
                                for (var n, o = [], i = e; i < r; i += 3) n = (t[i] << 16 & 16711680) + (t[i + 1] << 8 & 65280) + (255 & t[i + 2]), o.push(f(n));
                                return o.join("")
                            }
            ...
            ! function () {
                var e = {
                        162: function (t) {
                            ...
                            function h() {
                                f && u && (f = !1, u.length ? a = u.concat(a) : c = -1, a.length && p())
                            }
                            ...
                            n.nextTick = function (t) {
                                ...
                                a.push(new l(t, e)), 1 !== a.length || f || s(p)
