    ...
    [179], {
                    ...
                    return o.default.wrap((function (e) {
                        for (;;) switch (e.prev = e.next) {
                            case 0:
                                ...
                                }), U = P.getURL(), g.hasBasePath(U) && (U = g.delBasePath(U)), q.scriptLoader && (0, r(3573).z)(q.scriptLoader), W = new E.default(q.buildId, t), n = function (e) {
                                    var t = f(e, 2),
                                        r = t[0],
                                        n = t[1];
        ...
        1003: function (e, t, r) {
            ...
            Object.defineProperty(t, "__esModule", {
                ...
                return !1
            }, t.addLocale = k, t.delLocale = A, t.hasBasePath = M, t.addBasePath = L, t.delBasePath = I, t.isLocalURL = T, t.interpolateAs = N, t.resolveHref = F, t.default = void 0;
            var p = r(2700),
                d = r(2497),
                h = function (e) {
                    if (e && e.__esModule) return e;
                            ...
                            return o.default.wrap((function (o) {
                                for (;;) switch (o.prev = o.next) {
                                    ...
                                    case 3:
                                        ...
                                        break;
                                    case 19:
                                        if (a._h || (c.isSsr = !1), g.ST && performance.mark("routeChange"), m = a.shallow, _ = void 0 !== m && m, P = a.scroll, O = void 0 === P || P, R = {
                                                shallow: _
                                            }, c._inFlightRoute && c.abortComponentLoad(c._inFlightRoute, R), n = L(k(M(n) ? I(n) : n, a.locale, c.defaultLocale)), j = A(M(n) ? I(n) : n, y.locale), c._inFlightRoute = n, F = v !== y.locale, a._h || !c.onlyAHashChange(j) || F) {
                                            o.next = 36;
                                            break
                                        }
                                        return y.asPath = j, e.events.emit("hashChangeStart", n, R), c.changeState(t, r, n, l({}, a, {
                                            scroll: !1
                                        })), O && c.scrollToHash(j), c.set(y, c.components[y.route], null), e.events.emit("hashChangeComplete", n, R), o.abrupt("return", !0);
                                    case 36:
                                    ...
                                    case 55:
                                        if (c.urlIsNew(j) || F || (t = "replaceState"), V = n, B = B ? p.removePathTrailingSlash(I(B)) : B, !s || "/_error" === B) {
                                            o.next = 70;
                                            break
                                        }
                                        ...
                                        break;
                                    case 65:
                                        V = X.asPath, X.matchedPage && X.resolvedHref && (B = X.resolvedHref, q.pathname = L(B), r = E.formatWithValidation(q)), o.next = 70;
                                        break;
                                    case 69:
                                        q.pathname = W(B, $), q.pathname !== B && (B = q.pathname, q.pathname = L(B), r = E.formatWithValidation(q));
                                    case 70:
                                        if (T(n)) {
                                            o.next = 75;
                                            break
                                    ...
                                    case 75:
                                        if (V = A(I(V), y.locale), a.shallow && 1 !== a._h || 1 === a._h && !b.isDynamicRoute(p.removePathTrailingSlash(B))) {
                                            o.next = 96;
                                            break
                                        }
                                    ...
                                    case 79:
                                        ...
                                        z = l({}, z, Y.parsedAs.query), V = Y.asPath, B = Y.resolvedHref, q.pathname = Y.resolvedHref, r = E.formatWithValidation(q), o.next = 96;
                                        break;
                                    case 84:
                                    ...
                                    case 141:
                                        return o.next = 143, c.getRouteInfo(ve, ve, z, n, V, {
                                            shallow: !1
                        ...
                        return u(o.default.mark((function a() {
                            ...
                            return o.default.wrap((function (o) {
                                for (;;) switch (o.prev = o.next) {
                                    ...
                                    case 18:
                                        f = A(I(y.asPath), n.locale), y.matchedPage && y.resolvedHref && (u = y.resolvedHref, i.pathname = u, e = E.formatWithValidation(i)), o.next = 23;
                                        break;
                                    case 22:
                                        i.pathname = W(i.pathname, s), i.pathname !== u && (u = i.pathname, i.pathname = u, e = E.formatWithValidation(i));
                                    case 23:
                                        o.next = 25;
                                        break;
                                    case 25:
                                    ...
                                    case 27:
                                        return "rewrite" === (v = o.sent).type && (i.pathname = v.resolvedHref, u = v.resolvedHref, c = l({}, c, v.parsedAs.query), f = v.asPath, e = E.formatWithValidation(i)), m = p.removePathTrailingSlash(u), o.next = 32, Promise.all([n.pageLoader._isSsg(m).then((function (t) {
                    ...
                    value: function (e) {
                        ...
                        return u(o.default.mark((function r() {
                            ...
                            return o.default.wrap((function (r) {
                                for (;;) switch (r.prev = r.next) {
                                    case 0:
                                        return n = C(e.as), a = A(M(n) ? I(n) : n, e.locale), r.next = 4, t.pageLoader.getMiddlewareList();
                                    case 4:
                                        ...
                                        })), c = O.getRoutingItems(e.pages, u), s = !1, l = !0, d = !1, h = void 0, r.prev = 9, y = c[Symbol.iterator]();
                                    case 11:
                                        if (l = (m = y.next()).done) {
                                            r.next = 19;
                                            break
                                    ...
                                    case 48:
                                        return _ = w.parseRelativeUrl(v.normalizeLocalePath(M(b.rewrite) ? I(b.rewrite) : b.rewrite, t.locales).pathname), P = p.removePathTrailingSlash(_.pathname), e.pages.includes(P) ? (S = !0, x = P) : (x = W(P, e.pages)) !== _.pathname && e.pages.includes(x) && (S = !0), r.abrupt("return", {
                                            type: "rewrite",
                                            asPath: _.pathname,
                                            parsedAs: _,
                                            matchedPage: S,
                                    ...
                                    case 54:
                                        ...
                                        return E = p.removePathTrailingSlash(v.normalizeLocalePath(M(b.redirect) ? I(b.redirect) : b.redirect, t.locales).pathname), R = U(t, E, E), j = R.url, k = R.as, r.abrupt("return", {
                                            type: "redirect",
                                            newUrl: j,
                                            newAs: k
                                        });
        ...
        4522: function (e, t, r) {
            ...
            Object.defineProperty(t, "__esModule", {
                ...
                (e = o(e)).startsWith("") && !n.isDynamicRoute(e) ? e = e.slice(6) : "" === e && (e = "/");
                return e
            };
            var n = r(8588);
